...
This means one can have an always-on pcibd instance running, and another local pcibd/pcib-qt instance which connects to this node and receives blocks from it.
