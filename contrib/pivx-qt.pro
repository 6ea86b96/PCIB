...
RESOURCES += src/qt/pcib.qrc src/qt/pcib_locale.qrc

TRANSLATIONS += src/qt/locale/pcib_bg.ts \
                src/qt/locale/pcib_de.ts \
                src/qt/locale/pcib_en.ts \
                src/qt/locale/pcib_es.ts \
                src/qt/locale/pcib_fi.ts \
                src/qt/locale/pcib_fr.ts \
                src/qt/locale/pcib_it.ts \
                src/qt/locale/pcib_ja.ts \
                src/qt/locale/pcib_pl.ts \
                src/qt/locale/pcib_pt.ts \
                src/qt/locale/pcib_ru.ts \
                src/qt/locale/pcib_sk.ts \
                src/qt/locale/pcib_sv.ts \
                src/qt/locale/pcib_vi.ts \
                src/qt/locale/pcib_zh_CN.ts \
                src/qt/locale/pcib_zh_TW.ts
