...
mnbudget prepare proposal-name url payment_count block_start pcib_address monthly_payment_pcib [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ PCIB, _12_ times over the course of a year totaling _24000_ PCIB. 
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` PCIB. 
