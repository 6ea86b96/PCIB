...
Only requiring some minor changes is pcib.cpp.
...
Changes to pcib.cpp
----------------------
pcib.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
