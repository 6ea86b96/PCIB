    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("PCIB Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About PCIB Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pcib-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("PCIB Core is shutting down...") + "<br /><br />" +
