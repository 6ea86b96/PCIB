    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PCIB Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PCIB address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pcib: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PCIB Core"), this);
    aboutAction->setStatusTip(tr("Show information about PCIB Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PCIB"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PCIB addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PCIB addresses"));
    ...
    openAction->setStatusTip(tr("Open a PCIB: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the PCIB Core help message to get a list with possible PCIB command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PCIB Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PCIB network", "", count));
}
...
{
    QString strTitle = tr("PCIB Core"); // default title
