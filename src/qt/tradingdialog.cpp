...
const QString apiBittrexTrades = "https://bittrex.com/api/v1.1/public/getmarkethistory?market=btc-pcib";
const QString apiBittrexOrders = "https://bittrex.com/api/v1.1/public/getorderbook?market=btc-pcib&type=both&depth=50";
...
{
    QString Response = sendRequest("https://bittrex.com/api/v1.1/public/getmarketsummary?market=btc-pcib");
    return dequote(Response);
}

QString tradingDialog::GetMarketHistory()
{
    QString Response = sendRequest("https://bittrex.com/api/v1.1/public/getmarkethistory?market=btc-pcib");
    return dequote(Response);
}

QString tradingDialog::GetOrderBook()
{
    QString  Response = sendRequest("https://bittrex.com/api/v1.1/public/getorderbook?market=btc-pcib&type=both&depth=50");
    return dequote(Response);
}
