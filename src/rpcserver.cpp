...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Pivx features */
    { "pcib",               "masternode",             &masternode,             true,      true,       false },
    { "pcib",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "pcib",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "pcib",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "pcib",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "pcib",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "pcib",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "pcib",               "obfuscation",               &obfuscation,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use pcibd, or the -server option to pcib-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
              ...
              "for example: alertnotify=echo %%s | mail -s \"PCIB Alert\" admin@foo.com\n"),
...
std::string HelpExampleCli(string methodname, string args){
    return "> pcib-cli " + methodname + " " + args + "\n";
}
