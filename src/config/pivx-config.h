/* src/config/PCIB-config.h.  Generated from PCIB-config.h.in by configure.  */
/* src/config/PCIB-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.PCIB.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PCIB Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PCIB Core 2.1.7"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "PCIB"
