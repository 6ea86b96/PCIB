...
//! These need to be macros, as clientversion.cpp's and pcib*-res.rc's voodoo requires it
...
/**
 * pcibd-res.rc includes this file, but it cannot cope with real c++ code.
